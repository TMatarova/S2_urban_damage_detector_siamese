...
os.chdir(r"C:\Users\Taula\Downloads\original_model")
# Path for split dataset used for training
NPZ_PATH = r"C:\Users\Taula\Downloads\original_model\FinalBalanced_splits.npz"
...
class SiameseCNN(nn.Module):
    def __init__(self, in_channels=3):
        ...
        self.head = nn.Sequential(
            nn.Linear(8192, 4096), nn.BatchNorm1d(4096), nn.GELU(), nn.Dropout(0.5),
